...
and covariance matrix that achieves a per-trait variance of 1 and a correlation across traits of 1.
This implies that the effects of the causal variants are equal across responses. In addition, the 
number of causal variants was set to 50,000. In this scenario, $\pi$ was initialized as 0.001 in 
*BayesR* and *mvBayesC*.
...
to the scenario with 5 traits is small. *mvBayesC* is currently too slow to be run in this scenario. 