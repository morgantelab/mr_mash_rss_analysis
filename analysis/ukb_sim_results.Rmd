...
analysis. The results show that *mr.mash.rss* clearly does better than *LDpred2 auto*.
...
from the data and performs similar to *LDpred2 auto*, although a little worse.
