...
rank) residual covariance and the mixture weights, without standardizing the variables. The residual
covariance was initialized as in the [mvSuSiE paper](https://www.biorxiv.org/content/10.1101/2023.04.14.536893v1)
...
In this scenario, the effects were drawn from a mixture of two Multivariate Normal distributions, each 
with mean vector 0 but with different covariance matrix.
