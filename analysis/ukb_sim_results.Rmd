...
In this scenario, the effects were drawn from a mixture of two Multivariate Normal distributions, were drawn 
from $w_1 MVN(0, \Sigma_1) + w_2 MVN(0, \Sigma_2)$, where $w_1$ = 0.5 and $w_2$ = 0.5. $\Sigma_1$ is such 
