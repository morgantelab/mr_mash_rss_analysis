...
methodz <- c("mr_mash_rss", "mvbayesC", "ldpred2_auto", "bayesR")
...
and *BayesR*, which perform similarly. *mvBayesC* does better than the univariate 
methods, but not as well as *mr.mash.rss*.
...
*mvBayesC* performs slightly worse than *mr.mash.rss*.
...
very similarly in traits 3 and 4, with *mvBayesC* being a tiny bit better. However, the two multivariate
methods perform better than the univariate methods in traits 1-3, due to the higher effect correlation across 
traits, the larger number of traits with shared effects, and the smaller $h^2_g$ (harder scenario for 
univariate methods).
...
*mr.mash.rss* clearly does better than *LDpred2 auto*. 
...
scenario with 5 traits is small. 