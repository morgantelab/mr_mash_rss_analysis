...
initialized as 0.0001 and other default parameters. NB this is a univariate method. 
...
causal variants) initialized as 0.0001 and other default parameters. NB this is a multivariate method. 
We used the implementation in the *qgg* R package.
...
and *BayesR*, which perform similarly. *mvBayesC* does not seem to do better than the univariate 
methods, although no worse than them.
