...
###Read in data
pheno_dat <- readRDS("../data/phenotypes/ukb_cleaned_bc_sampled_covar_pheno.rds")
...
###Load genotype data
geno <- snp_attach("/scratch1/fabiom/ukb_bc_sampled_geno_imp_prior.rds")
...
#Prepare phenotypes
pheno <- pheno_dat[, c("WBC_count", "RBC_count", "Haemoglobin", "MCV", "RDW", "Platelet_count", "Plateletcrit", "PDW", 
...
saveRDS(out, file=paste0("../output/summary_statistics/ukb_bc_sampled_chr", chr, "_prior_sumstats_", fold, ".rds"))
