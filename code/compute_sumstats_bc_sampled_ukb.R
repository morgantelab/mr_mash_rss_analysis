...
###Load genotype data
geno <- snp_attach("/scratch1/fabiom/ukb_bc_sampled_geno_imp_HM3.rds")
...
saveRDS(out, file=paste0("../output/summary_statistics/ukb_bc_sampled_chr", chr, "_sumstats_", fold, ".rds"))
