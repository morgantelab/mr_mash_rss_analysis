...
sel_ids <- bigreadr::fread2("../data/LD_matrices/ukb_tiezzi_BP_inds_for_LD.txt")
...
###Keep only individuals not retained by Francesco
ids <- ids[-1, ]
...
rds <- bigsnpr::snp_readBGEN(
  ...
  backingfile = "/scratch1/fabiom/ukb_geno_imp_HM3_tiezzi_for_LD",
